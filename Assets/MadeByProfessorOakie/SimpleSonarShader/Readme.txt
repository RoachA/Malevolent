...
4. Set the Render Pipeline Asset for your quality levels to use the ColorMinis_URPAsset
...
----
Integrate into your existing Scriptable Render Pipeline: 
You should be able to just copy the Renderer Features into what you already have setup. 